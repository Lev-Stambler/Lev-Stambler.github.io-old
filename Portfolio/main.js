...
const photoGalleryMod = new module('gallery-photo', ``, ``)
photoGalleryMod.setHTMLSource('trivMods/gallery-photo.htm')
photoGalleryMod.init()

trivial.updatingModule([pSmall, pageBreak])

trivial.updateDOM()

const aSPModule = new singlePageLink(330, () => loadPageFromUrl());
aSPModule.addEvent('click', () => {
...
if(mobilecheck()) $('body').append(`<style>body {
    zoom: 2;
